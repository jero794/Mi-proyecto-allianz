...
st.write("VAMOS A HACER BILLETE$$$$$$")
...
# Mostrar todos los ETFs ordenados
st.subheader("Todos los ETFs disponibles (ordenados por rendimiento):")
st.dataframe(df_etfs.style.format({"Rendimiento": "{:.2%}", "Riesgo": "{:.2%}"}))
